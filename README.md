...
<p align="center">
  <a href="https://github.com/ogyamada/groundtruth/actions/workflows/ci.yml"><img src="https://github.com/ogyamada/groundtruth/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
  ...
  <a href="https://github.com/ogyamada/groundtruth/blob/main/CONTRIBUTING.md"><img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg" alt="PRs welcome"></a>
</p>
...
```text
/plugin marketplace add ogyamada/groundtruth
  ...
  claim-check:
    ...
    steps:
      - uses: actions/checkout@v6
        with: { fetch-depth: 0 }
      - uses: ogyamada/groundtruth@v0.2.0
```
...
<a href="https://star-history.com/#ogyamada/groundtruth&Date">
  <img src="https://api.star-history.com/svg?repos=ogyamada/groundtruth&type=Date" alt="Star History Chart" width="600">
</a>
